...
SELECT "Cardápio", "cardapio.php", "icon-cutlery", 1, 0, "cardapio", "cardapio/cardapio.js", "2019-05-07", "72b4b1d7ce2b514a981a49b1db5790a7", "{\"item\":[\"adicionar\",\"editar\",\"deletar\"],\"categoria\":[\"adicionar\",\"editar\",\"deletar\"],\"codigo\":[\"acessar\"],\"configuracao\":[\"acessar\"]}";
...
CREATE TABLE IF NOT EXISTS `cardapio_config` (
   ...
   VALUES (1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
    ...
    ALTER TABLE `cardapio_item` ADD `ordem` INT(11) NULL AFTER `img`;